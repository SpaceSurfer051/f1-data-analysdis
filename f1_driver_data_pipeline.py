...
with DAG(
    ...
    def get_driver_data(bucket_name, **kwargs):
        try:
            ...
            driver_df["team_name"] = driver_df.groupby("full_name")[
                "team_name"
            ...
            driver_df["country_code"] = driver_df.groupby("full_name")[
                "country_code"
            ].transform(lambda x: x.ffill().bfill())
